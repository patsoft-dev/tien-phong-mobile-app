...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      backgroundColor: Color(0xff00BD67),
      splashColor: Color(0xffeeeeee).withAlpha(100),
      highlightElevation: 8,
      elevation: 4,
      focusColor: Color(0xff00BD67),
      hoverColor: Color(0xff00BD67),
    ...
    tabBarTheme: TabBarThemeData(
      ...
      labelColor: Color(0xff00BD67),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xff00BD67), width: 2.0),
      ),
    ),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      fillColor: WidgetStateProperty.all(Color(0xff00BD67)),
    ),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff00BD67),
      inactiveTrackColor: Color(0xff00BD67).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff00BD67),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xff00BD67)),
      ),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff00BD67),
      inactiveTrackColor: Color(0xff00BD67).withAlpha(100),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff00BD67),
      thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
